...
#         file = {'idServico': idServico.id_Servicos,
#                 'maquina': maquina.Servicos,
#                 'linhaMaq': linhaMaq.Servicos,
#                 'trecho': trecho.Servicos,
#                 'tipLub': tipLub.Servicos,
# 				'dataAplic' : dataAplic.Servicos,
# 				'freqAplic': freqAplic.Servicos,
# 				'obs': obs.Servicos}
#         resposta['files'].append(file)
#     return(resposta)
